...
- (void)viewDidLoad {
    ...
    GLKTextureInfo *textuerInfo = [GLKTextureLoader textureWithCGImage:imageRef options:nil error:NULL];
...
- (void)setupUI
{
    ...
    labelFliter.textColor = [UIColor blueColor];
    ...
    labelAnimation.textColor = [UIColor blueColor];
    ...
    labelTexture.textColor = [UIColor blueColor];
